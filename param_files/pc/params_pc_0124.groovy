...
data_method_pairs_grouped = ["frangieh/co_culture/gene": ["sceptre", "seurat_de", "liscovitch_method", "seurat_de_nb", "weissman_method"],
                             "frangieh/control/gene": ["sceptre", "seurat_de", "liscovitch_method", "seurat_de_nb", "weissman_method"],
                             "frangieh/ifn_gamma/gene": ["sceptre", "seurat_de", "liscovitch_method", "seurat_de_nb", "weissman_method"],
                             "papalexi/eccite_screen/gene": ["sceptre", "seurat_de", "liscovitch_method", "seurat_de_nb", "weissman_method"],
                             "papalexi/eccite_screen/protein": ["sceptre", "seurat_de", "liscovitch_method", "seurat_de_nb", "weissman_method"],
                             "schraivogel/enhancer_screen_chr11/gene": ["sceptre", "seurat_de", "liscovitch_method", "seurat_de_nb", "weissman_method"],
                             "schraivogel/enhancer_screen_chr8/gene": ["sceptre", "seurat_de", "liscovitch_method", "seurat_de_nb", "weissman_method"],
                             "simulated/experiment_2/gene": ["sceptre", "seurat_de", "liscovitch_method", "seurat_de_nb", "weissman_method"]
                            ]
