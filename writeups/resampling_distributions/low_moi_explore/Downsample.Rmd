...
B <- 100
set.seed(1)
overshoot_left_fit <- list()
overshoot_left_power <- list()
undershoot_left_fit <- list()
undershoot_left_power <- list()
for (s in 1:10) {
  ...
  overshoot_left_fit[[s]] <- overshoot_sim_fit
  undershoot_left_fit[[s]] <- undershoot_sim_fit
  overshoot_left_power[[s]] <- overshoot_sim_power
  undershoot_left_power[[s]] <- undershoot_sim_power
  print(s)
}

# save file
write.csv(overshoot_left_fit, "overshoot_left_fit.csv")
write.csv(overshoot_left_power, "overshoot_left_power.csv")
write.csv(undershoot_left_fit, "undershoot_left_fit.csv")
write.csv(undershoot_left_power, "undershoot_left_power.csv")
