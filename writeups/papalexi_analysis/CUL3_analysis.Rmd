...
pathways[,2] = signif(as.numeric(pathways[,2]), digits=2)
#make table
results = kable(pathways,booktabs = TRUE, linesep = "",
  caption = "Pathway Enrichment Analysis With Top 300 Genes by Log Fold Change")
...
#make table
results = kable(pathways,booktabs = TRUE, linesep = "",
  caption = "Pathway Enrichment Analysis With Top 300 Genes by Pvalue")
kable_styling(results,position = "center", latex_options = "scale_down")
