...
pc_res_sceptre_exact <- readRDS(paste0(result_dir, "positive_control_analysis/pc_results_sceptre_exact.rds")) |>
...
pc_res <- readRDS(paste0(result_dir, "positive_control_analysis/pc_results.rds")) |>
  mutate(method = forcats::fct_recode(method, "sceptre (sn)" = "sceptre"))
pc_res_comb <- rbind(pc_res, pc_res_sceptre_exact) |>
...
```{r}
n_bonf_reject <- compute_n_bonf_rejected(pc_res_comb)
