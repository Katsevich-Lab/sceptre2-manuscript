...
Next, I plot the results of five methods on the Schraivogel enhancer screen negative control data: SCEPTRE (exact), Schraivogel method, Seurat DE, Weissman method, and NB regression. I filter for pairs with >= 7 nonzero treatment cells >= 30 nonzero control cells.
