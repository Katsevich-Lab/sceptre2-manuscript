...
This repository contains code to reproduce the analyses reported in the paper "Robust differential expression testing for single-cell CRISPR screens at low multiplicty of infection" (Genome Biology, 2024). Given the complexity of the codebase, we encourage readers interested in reproducing one or more of the analyses to reach out to the authors (TB: tbarry@hsph.harvard.edu, EK: ekatsevi@wharton.upenn.edu).
