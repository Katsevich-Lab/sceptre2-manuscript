...
This repository contains code to reproduce all analyses reported in the paper "Robust differential expression testing for single-cell CRISPR screens at low multiplicty of infection" by Barry et al. 2023. This document provides instructions for reproducing the analyses.
