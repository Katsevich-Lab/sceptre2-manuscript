...
# Perform Marker Gene Analysis/Pathway Enrichment Analysis
...
# Perform Marker Gene Analysis/Pathway Enrichment Analysis on Normalized Data

When using the normalized data, clearly the results are not at all the same.
```{r}
CUL3_marker = FindMarkers(eccite,ident.1 = 'CUL3 KO',ident.2 = 'NT',
                          assay = 'PRTB',only.pos = T)
```
