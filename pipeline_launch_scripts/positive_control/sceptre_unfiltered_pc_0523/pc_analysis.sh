...
nextflow run pc-grna-pipeline -r main \
 --data_method_pair_file $LOCAL_CODE_DIR"/sceptre2-manuscript/param_files/pc/params_pc_sceptre_unfiltered_0523.groovy" \
 --grna_modality "assignment" \
 --result_dir $LOCAL_SCEPTRE2_DATA_DIR"/results/positive_control_analysis" \
 --result_file_name "pc_results_sceptre_unfiltered_0523.rds" \
 --trial "false" \
